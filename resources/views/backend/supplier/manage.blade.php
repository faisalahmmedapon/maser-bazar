            ...
            <div class="row clearfix">
                ...
                <div class="col-md-5 col-sm-5 col-lg-5">
                    <div class="row pb-3">
                        ...
                        <div class="col">
                            <label for="searchFish" class="form-label">Search Fish</label>
                            <input class="form-control" id="searchFish"
                                   placeholder="Type to search...">
                        </div>
                    </div>
                    <div id="search-fish">
                        <div class="row" id="search-fish-item">
                ...
                <div class="modal-content">
                    ...
                    <form class="update_supplier_sell_fishes_form" id="update_supplier_sell_fishes_form" method="POST">
                        ...
                        <div class="modal-body">
                            <input type="hidden" class="form-control" id="update_supplier_sell_fishes_row_id"
                                   name="update_supplier_sell_fishes_row_id">

                            <div class="mb-3">
                                <label class="form-label">Customer Name</label>
                                <select id="update_supplier_sell_fishes_customer_name"
                                        name="update_supplier_sell_fishes_customer_name"
                                        class="single-select select2-hidden-accessible" data-select2-id="1"
